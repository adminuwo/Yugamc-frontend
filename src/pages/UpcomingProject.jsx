    ...
    <div className="bg-[#f8f6f2] text-[#2B2B2B] min-h-screen overflow-x-hidden selection:bg-[#c47a5a] selection:text-[#f8f6f2] font-sans">
      ...
      <section className="py-16 md:py-24 relative z-10 w-full overflow-hidden">
        <div className="container mx-auto px-6 max-w-[90rem]">
          ...
          >
            <motion.div className="w-full lg:w-[65%] relative group h-[400px] md:h-[500px] lg:-ml-12 rounded-[30px] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] z-10">
              <motion.img 
      ...
      <section className="py-16 md:py-24 relative z-10 w-full overflow-hidden">
        <div className="container mx-auto px-6 max-w-[90rem]">
          ...
          >
            ...
            <motion.div className="w-full lg:w-[65%] relative group h-[400px] md:h-[500px] lg:-mr-12 rounded-[30px] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] z-10">
              <motion.img 
